...
def run_ingestion():
    ...
    all_dist.to_pandas().to_sql("master_distilleries", conn, if_exists="replace", index=False)
    ...
    if master_records:
        ...
        # Load to SQL
        full_df.to_pandas().to_sql("distillery_stats", conn, if_exists="replace", index=False)
